            ...
            <div class="row">
              <div class="col-md-12 form-group">
                ...
                <select name="customer" id="customer" class="selectpicker"data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" >
                    ...
                    <option value="<?php echo html_entity_decode($s['userid']); ?>" <?php if (isset($order) && $order->customer == $s['userid']) {echo 'selected';}?>><?php echo html_entity_decode($s['company']); ?></option>
                      <?php }?>
                </select>
              </div>
               <div class="col-md-12">
