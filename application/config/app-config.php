...
*
*/
define('APP_BASE_URL', 'https://crm.hoogli.dev.br/');
...
*/
define('APP_ENC_KEY', 'b36a7d3c9330bddbc1fef4d41b9d02b1');
 ...
 */
define('APP_DB_USERNAME', 'hooglidev_hoogli2');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Hoogli@2002');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'hooglidev_crm');
